...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['debito', 'R$ 23,00', ['combo1,2', 'queijo,2']],
        ['debito', 'R$ 43,15', ['suco,2', 'salgado,1', 'sanduiche,3', 'queijo,2']],
    ...
    test.each([
        ['R$ 39,50', 'debito', 'Valor do item extra não pode ser maior que do item principal', ['cafe,4', 'sanduiche,3', 'queijo,4']],
        ['R$ 39,00', 'debito', 'Valor do item extra não pode ser maior que do item principal', ['cafe,4', 'sanduiche,3', 'chantily,5']],
        ['R$ 25,00', 'debito', 'Valor do item extra não pode ser maior que do item principal', ['combo1,2', 'queijo,3']],
        ['R$ 15,00', 'debito', 'Valor do item extra não pode ser maior que do item principal', ['combo2,1', 'chantily,5']],

    ])('compra de múltiplas quantidades no valor de %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
});
